...
>>skiped			TF_ReplaceLine(INV_GEN,"24739",24739,"        ShotTime(0.28); //Modified_by_FireEyeEian")
...
TF_ReplaceLine(INV_GEN,"23057",18907,"        ShootMaxAngle(0.064); //Modified_by_FireEyeEian") 
...
TF_ReplaceLine(INV_GEN,"23840",23839,"        ReloadTime(2.95); //Modified_by_FireEyeEian")         
TF_ReplaceLine(INV_GEN,"23862",23840,"        ShootVertRecoil(0.035); //Modified_by_FireEyeEian")
...
TF_ReplaceLine(INV_GEN,"23879",23878,"        ReloadTime(2.65); //Modified_by_FireEyeEian")        
TF_ReplaceLine(INV_GEN,"23901",23879,"        ShootVertRecoil(0.030); //Modified_by_FireEyeEian")
;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
;;;Burts_gen_upgrade_3
;TF_ReplaceLine(INV_GEN,"19739",19739,"        ShotTime(0.07); //Modified_by_FireEyeEian")          
TF_ReplaceLine(INV_GEN,"23918",23917,"        ReloadTime(2.35); //Modified_by_FireEyeEian")        
TF_ReplaceLine(INV_GEN,"23940",23918,"        ShootVertRecoil(0.025); //Modified_by_FireEyeEian")
;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
			;;;Burst_gen_b_upgrade_1
			;TF_ReplaceLine(INV_GEN,"19879",19879,"        ShotTime(0.09); //Modified_by_FireEyeEian")          
			TF_ReplaceLine(INV_GEN,"24065",24064,"        ReloadTime(2.95); //Modified_by_FireEyeEian")         
			TF_ReplaceLine(INV_GEN,"24087",24065,"        ShootVertRecoil(0.035); //Modified_by_FireEyeEian")
			;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
			;;;Burst_gen_b_upgrade_2
			;TF_ReplaceLine(INV_GEN,"19918",19918,"        ShotTime(0.08); //Modified_by_FireEyeEian")          
			TF_ReplaceLine(INV_GEN,"24104",24103,"        ReloadTime(2.65); //Modified_by_FireEyeEian")        
			TF_ReplaceLine(INV_GEN,"24126",24104,"        ShootVertRecoil(0.030); //Modified_by_FireEyeEian")
			;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
			;;;Burts_gen_b_upgrade_3
			;TF_ReplaceLine(INV_GEN,"19957",19957,"        ShotTime(0.07); //Modified_by_FireEyeEian")          
			TF_ReplaceLine(INV_GEN,"24143",24142,"        ReloadTime(2.35); //Modified_by_FireEyeEian")        
			TF_ReplaceLine(INV_GEN,"24165",24143,"        ShootVertRecoil(0.025); //Modified_by_FireEyeEian")
			;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
;;;singleshot_gen_upgrade_1
;TF_ReplaceLine(INV_GEN,"20097",20097,"        ShotTime(0.095); //Modified_by_FireEyeEian")          
TF_ReplaceLine(INV_GEN,"24290",24289,"        ReloadTime(2.95); //Modified_by_FireEyeEian")         
TF_ReplaceLine(INV_GEN,"24312",24290,"        ShootVertRecoil(0.035); //Modified_by_FireEyeEian")
;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
;;;singleshot_gen_upgrade_2
;TF_ReplaceLine(INV_GEN,"20136",20136,"        ShotTime(0.08); //Modified_by_FireEyeEian")          
TF_ReplaceLine(INV_GEN,"24329",24328,"        ReloadTime(2.65); //Modified_by_FireEyeEian")        
TF_ReplaceLine(INV_GEN,"24351",24329,"        ShootVertRecoil(0.030); //Modified_by_FireEyeEian")
;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
;;;singleshot_gen_upgrade_3
;TF_ReplaceLine(INV_GEN,"20175",20175,"        ShotTime(0.07); //Modified_by_FireEyeEian")          
TF_ReplaceLine(INV_GEN,"24368",24367,"        ReloadTime(2.35); //Modified_by_FireEyeEian")        
TF_ReplaceLine(INV_GEN,"24390",24368,"        ShootVertRecoil(0.025); //Modified_by_FireEyeEian")
;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
			;;;singleshot_gen_b_upgrade_1
			;TF_ReplaceLine(INV_GEN,"20097",20097,"        ShotTime(0.095); //Modified_by_FireEyeEian")          
			TF_ReplaceLine(INV_GEN,"24515",24514,"        ReloadTime(2.95); //Modified_by_FireEyeEian")         
			TF_ReplaceLine(INV_GEN,"24537",24515,"        ShootVertRecoil(0.035); //Modified_by_FireEyeEian")
			;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
			;;;singleshot_gen_b_upgrade_2
			;TF_ReplaceLine(INV_GEN,"20136",20136,"        ShotTime(0.08); //Modified_by_FireEyeEian")          
			TF_ReplaceLine(INV_GEN,"24554",24553,"        ReloadTime(2.65); //Modified_by_FireEyeEian")        
			TF_ReplaceLine(INV_GEN,"24576",24554,"        ShootVertRecoil(0.030); //Modified_by_FireEyeEian")
			;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian") 
			;;;singleshot_gen_b_upgrade_3
			;TF_ReplaceLine(INV_GEN,"20175",20175,"        ShotTime(0.07); //Modified_by_FireEyeEian")          
			TF_ReplaceLine(INV_GEN,"24593",24592,"        ReloadTime(2.35); //Modified_by_FireEyeEian")        
			TF_ReplaceLine(INV_GEN,"24615",24593,"        ShootVertRecoil(0.025); //Modified_by_FireEyeEian")
			;TF_ReplaceLine(INV_GEN,"18942",18942,"        ShootMaxAngle(0.059); //Modified_by_FireEyeEian")
;;;;;;Shottys
